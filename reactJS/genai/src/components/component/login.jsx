...
* @see https://v0.dev/t/xcfP2vElXYw
      ...
      <div className="bg-zinc-200 rounded-lg shadow-lg p-8 max-w-md w-full">
        ...
        <form onSubmit={handleFormSubmit}>
          <div className="mb-4">
            ...
            <Input id="email" placeholder="Enter your email" type="text" name="email" value={loginData.email} onChange={handleInputChange}/>
          </div>
          <div className="mb-4">
            <Label className="block mb-2 text-zinc-800" htmlFor="password">
              Password
            </Label>
            <Input id="pwd" placeholder="Enter your password" type="text" name="pwd" value={loginData.pwd} onChange={handleInputChange}/>
          </div>
